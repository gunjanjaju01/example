...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng eiffel = new LatLng(48.8589, 2.2936);
        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                ...
                ActivityCompat.requestPermissions(this, new String[]{Manifest
                        .permission.ACCESS_FINE_LOCATION}, FINE_LOCATION_ACESS_REQUEST_CODE);
            } else {
                ActivityCompat.requestPermissions(this, new String[]{Manifest.
                        permission.ACCESS_FINE_LOCATION}, FINE_LOCATION_ACESS_REQUEST_CODE);
            }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == BACKGROUND_LOCATION_ACESS_REQUEST_CODE) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                //We do not have the Permission
                Toast.makeText(this, "Background locaton access is necessary for geofences to trigger..." +
        ...
        if(Build.VERSION.SDK_INT >= 29)
        {
            ...
            else
            {
                ...
                .ACCESS_BACKGROUND_LOCATION))
                {
                    ...
                    ActivityCompat.requestPermissions(this,new String[] {Manifest.
                    permission.ACCESS_BACKGROUND_LOCATION}, BACKGROUND_LOCATION_ACESS_REQUEST_CODE);
                }
                   else
                {
                    ActivityCompat.requestPermissions(this,new String[] {Manifest.
